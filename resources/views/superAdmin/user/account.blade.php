...
@section('h4-page', 'จัดการบัญชีสมาชิก')
        ...
        <div class="col-lg-12 col-md-6 mb-4">
            <div class="card">
                ...
                <div class="card-body px-2 pb-2">
                    <form method="GET" action="{{ route('showAccount') }}" class="row mb-3">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-2 mt-2">
                            ...
                            <a href="{{ route('showAccount') }}" class="btn btn-light">รีเซ็ต</a>
                        </div>
                    </form>
                            ...
                            <tbody>
                                @forelse ($users as $user)
                                    <tr>
                                        ...
                                        <td>
                                            @if($user->user_status == 'A')
                                                <a href="pdf-test.pdf" target="_blank" class="btn btn-sm btn-primary">วาระการประชุม</a>
                                            @else
                                                <a href="{{ route('user.openAccount', $user->user_id) }}" class="btn btn-sm btn-success">เปิดบัญชี</a>

{{--                                                {{$user->checkOpenAccountStatus()}}--}}
{{--                                                @if($user->checkOpenAccountStatus())--}}
{{--                                                    5555--}}
{{--                                                    <a href="{{ route('user.openAccount', $user->user_id) }}" class="btn btn-sm btn-success">เปิดบัญชี</a>--}}
{{--                                                @endif--}}
                                            @endif
