            ...
            <div class="card">
                <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        ...
                        <a href="{{ route('user.exportAll.pdf', request()->all()) }}" target="_blank" class="btn btn-danger">ส่งออกรายชื่อผู้สมัคร</a>
                    </div>
                                ...
                                @forelse ($users as $user)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @endif
                                            <a href="{{ route('user.edit', $user->user_id) }}" class="btn btn-sm btn-warning">แก้ไข</a>
                                            <a href="{{ route('user.export.pdf', $user->user_id) }}" class="btn btn-sm btn-info">พิมพ์ใบสมัคร</a>
                                        </td>
                                @empty
                                    <tr>
